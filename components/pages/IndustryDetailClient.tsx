...
export function IndustryDetailClient({ title, subtitle, description, benefits }: IndustryDetailProps) {
  return (
    <div className="pt-32 pb-20 bg-slate-950 min-h-screen">
      <div className="container mx-auto px-6 max-w-4xl">
        <motion.div
          ...
          className="mb-16"
        >
          <Link href="/industries" className="text-amber-500 hover:text-amber-400 flex items-center gap-2 mb-8 w-fit font-medium transition-colors">
        ...
        >
          <h2 className="text-2xl font-bold text-white mb-8">Industry-Specific Solutions</h2>
        ...
        >
          <h2 className="text-3xl font-bold text-slate-950 mb-4">Transform Your Operations</h2>
          <p className="text-slate-900/80 mb-8 max-w-2xl mx-auto text-lg">
            Schedule a free data audit to discover how our AI solutions can revolutionize your {title.toLowerCase()} business.
          </p>
